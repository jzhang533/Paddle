...
using Createdevice_workerFunction = std::shared_ptr<DeviceWorker> (*)();
typedef std::unordered_m;
using device_workerMap =
    std::unordered_map<std::string, Createdevice_workerFunction>;
